...
3. run PCA
4. create nearest neighboring network
5. do clustering

.. seealso:: 
	`doLouvainCluster_multinet <doLouvainCluster_multinet>`_, `doLouvainCluster_community <doLouvainCluster_community>`_, and `doLeidenCluster <doLeidenCluster>`_.